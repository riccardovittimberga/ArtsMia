...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnCercaPercorso=ft.ElevatedButton(text="Cerca Oggeti",on_click=self._controller.handleCercaPercorso)
        row2=ft.Row([self._ddLun, self._btnCercaPercorso])
